const data = {
  ...
  const spawnReplyInput = (parent, parentId, replyTo = undefined) => {
    ...
    addedInput.querySelector(".btn-main").addEventListener("click", () => {
      let commentBody = addedInput.querySelector(".cment-input").value;
  ...
  const createCommentNode = (commentObject) => {
    ...
    commentNode.querySelector(".cment-time").textContent = commentObject.createdAt;
  ...
  cmntInput.querySelector(".btn-main").addEventListener("click", () => {
    let commentBody = cmntInput.querySelector(".cment-input").value;
    if (commentBody.length == 0) return;
    addComment(commentBody, 0);
    cmntInput.querySelector(".cment-input").value = "";
  });
